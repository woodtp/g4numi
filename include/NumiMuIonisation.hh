...
// ********************************************************************
//
// $Id: NumiMuIonisation.hh,v 1.1.2.1 2010/08/19 19:50:54 minervacvs Exp $
// GEANT4 tag $Name:  $
//
// -------------------------------------------------------------------
//
...
#ifndef NumiMuIonisation_h
#define NumiMuIonisation_h 1
...
class NumiMuIonisation : public G4VEnergyLoss
{

public:

   NumiMuIonisation(const G4String& name = "numimuIoni",
                    G4ProcessType aType = fElectromagnetic );

  virtual ~NumiMuIonisation();
...
private:
   ...
   NumiMuIonisation & operator=(const NumiMuIonisation &right);
   NumiMuIonisation(const NumiMuIonisation&);
...
inline G4bool NumiMuIonisation::IsApplicable(const G4ParticleDefinition& p)
{
...
inline G4double NumiMuIonisation::MinPrimaryEnergy(const G4ParticleDefinition*,
						 const G4Material*,
						 G4double cut)
{
...
inline void NumiMuIonisation::InitialiseStep(const G4Track& track)
{
...
inline void NumiMuIonisation::InitialiseMassCharge(const G4Track&)
{
...
inline void NumiMuIonisation::DefineMaterial(const G4MaterialCutsCouple* couple)
{
...
inline G4VEmModel* NumiMuIonisation::SelectModel(G4double kinEnergy)
{
...
inline G4VEmModel* NumiMuIonisation::SelectModelForMaterial(G4double kinEnergy,
                                                            size_t& idx) const
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
inline G4double NumiMuIonisation::GetContinuousStepLimit(const G4Track& ,
                                                  G4double,
                                                  G4double,
                                                  G4double& )
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
inline G4double  NumiMuIonisation::GetMeanFreePath(const G4Track&,
                                                   G4double,
                                                   G4ForceCondition* condition)
{
...
inline G4double NumiMuIonisation::AlongStepGetPhysicalInteractionLength(const G4Track&,
                                                                        G4double,
                                                                        G4double,
                                                                        G4double&,
                                                                        G4GPILSelection*)
...
inline G4double NumiMuIonisation::GetScaledRangeForScaledEnergy(G4double e)
{
  G4bool b;
...
inline G4double NumiMuIonisation::GetDEDXForScaledEnergy(G4double e)
{
  G4bool b;
  G4double x = 
...
inline G4double NumiMuIonisation::ScaledKinEnergyForLoss(G4double r)
{
...
inline G4double NumiMuIonisation::PostStepGetPhysicalInteractionLength(
                             const G4Track& ,
                             G4double,
                             G4ForceCondition* condition)
{
...
void NumiMuIonisation::AddEmModel(G4int order, G4VEmModel* p, 
...
const G4String& NumiMuIonisation::GetProcessName() const
{
   return fName;
}
