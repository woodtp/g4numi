...
NA49EventActionMessenger::NA49EventActionMessenger(NA49EventAction* EvAct)
:eventAction(EvAct)
{ 
...
NA49EventActionMessenger::~NA49EventActionMessenger()
{
  delete drawCmd;
  delete printCmd;   
  delete dCmd;
...
void NA49EventActionMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{ 
  if(command == drawCmd)
