...
void NumiDetectorConstruction::ConstructSecMonitors()
{
 G4ThreeVector tunnelPos=G4ThreeVector(0,0,NumiData->TunnelLength/2.+NumiData->TunnelZ0);
  ...
  G4ThreeVector hadmon_pos=G4ThreeVector(0.,0.,723.25*m)-tunnelPos;
  
  new G4PVPlacement(0,hadmon_pos,"PVHadMon",LVhadmon,pvTUNE,false,0);
  ...
  G4ThreeVector mumona1_pos=G4ThreeVector(0.,0.,739.*m)-tunnelPos;
  
  new G4PVPlacement(0,mumona1_pos,"PVMuMonA1",LVmumona1,pvTUNE,false,0);
