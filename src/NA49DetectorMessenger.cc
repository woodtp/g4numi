...
NA49DetectorMessenger::NA49DetectorMessenger(NA49DetectorConstruction * Det)
:Detector(Det)
{
...
NA49DetectorMessenger::~NA49DetectorMessenger()
{
  delete matCmd;
  delete mat1Cmd;
  delete rCmd;
...
void NA49DetectorMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
  if( command == matCmd )
