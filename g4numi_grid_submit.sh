...
export HORN1_POSITION_Z="3.0"              #"3.0" #cm
export HORN2_POSITION_X="0"                #"0.0" #cm
export HORN2_POSITION_Y="0"                #"0.0" #cm
...
export BEAM_POSITION_X="0.0"               #"0" #mm
export BEAM_POSITION_Y="0.0"               #"0" #mm
export BEAM_SPOTSIZE_X="1.4"               #"1.4" #mm. Typical ME-era ACNET values are ~ 1.3, but must be
export BEAM_SPOTSIZE_Y="1.4"               #"1.4" #mm. scaled by 1.08 --> 1.4. (see Hylen numi ops 02/16/16)
