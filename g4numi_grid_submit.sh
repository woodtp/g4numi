...
# $Header: /cvs/projects/numi-beam-sim/numi-beam-sim/g4numi/Attic/g4numi_grid_submit.sh,v 1.1.2.7 2017/07/05 16:13:21 bmesserl Exp $
...
export HORN1_POSITION_X="2"                #"0.0" #cm
export HORN1_POSITION_Y="-2"                #"0.0" #cm
